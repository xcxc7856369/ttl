<template>
	<view class="content" style="background-image:url(../../static/login/register_bg.png)">
		<view class="box">
			...
			<view class="reg_view">
				<view class="title"><img src="../../static/login/reg_code.png" alt=""></view>
			...
			<view class="reg_view">
				...
				<input class="reg_input" placeholder="请输入密码" v-model="regis.password" placeholder-style="color:#fff;" />
			</view>
			<view class="agreement_box">
				<view class="agreement_icon"><image :src="check" :id="check_img" @tap="checked"></image></view>
				<view class="agreement_text">
					同意
					<navigator url="#">《镗镗锣用户协议》</navigator>
				</view>
			</view>
			<view class="btn_view">
				<button class="login" @tap="login_tap">注册</button>
			</view>
		</view>
	</view>
</template>
